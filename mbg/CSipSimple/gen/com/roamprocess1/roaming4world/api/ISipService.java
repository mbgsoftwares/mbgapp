 ...
 * Original file: D:\\2014-12-02_r4w\\s\\CSipSimple\\src\\com\\roamprocess1\\roaming4world\\api\\ISipService.aidl
 */
package com.roamprocess1.roaming4world.api;
public interface ISipService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.roamprocess1.roaming4world.api.ISipService
{
private static final java.lang.String DESCRIPTOR = "com.roamprocess1.roaming4world.api.ISipService";
...
/**
 * Cast an IBinder object into an com.roamprocess1.roaming4world.api.ISipService interface,
 * generating a proxy if needed.
 */
public static com.roamprocess1.roaming4world.api.ISipService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.roamprocess1.roaming4world.api.ISipService))) {
return ((com.roamprocess1.roaming4world.api.ISipService)iin);
}
return new com.roamprocess1.roaming4world.api.ISipService.Stub.Proxy(obj);
}
...
int _arg0;
_arg0 = data.readInt();
com.roamprocess1.roaming4world.api.SipProfileState _result = this.getSipProfileState(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
int _arg0;
_arg0 = data.readInt();
com.roamprocess1.roaming4world.api.SipCallSession _result = this.getCallInfo(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
com.roamprocess1.roaming4world.api.SipCallSession[] _result = this.getCalls();
reply.writeNoException();
...
{
data.enforceInterface(DESCRIPTOR);
com.roamprocess1.roaming4world.api.SipCallSession _arg0;
if ((0!=data.readInt())) {
_arg0 = com.roamprocess1.roaming4world.api.SipCallSession.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.roamprocess1.roaming4world.api.MediaState _result = this.getCurrentMediaState();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
long _arg2;
_arg2 = data.readLong();
this.sendTyping(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
private static class Proxy implements com.roamprocess1.roaming4world.api.ISipService
{
...
/**
	...
	*/
@Override public com.roamprocess1.roaming4world.api.SipProfileState getSipProfileState(int accountId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.roamprocess1.roaming4world.api.SipProfileState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(accountId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.roamprocess1.roaming4world.api.SipProfileState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.roamprocess1.roaming4world.api.SipCallSession getCallInfo(int callId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.roamprocess1.roaming4world.api.SipCallSession _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(callId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.roamprocess1.roaming4world.api.SipCallSession.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.roamprocess1.roaming4world.api.SipCallSession[] getCalls() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.roamprocess1.roaming4world.api.SipCallSession[] _result;
...
_reply.readException();
_result = _reply.createTypedArray(com.roamprocess1.roaming4world.api.SipCallSession.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public void adjustVolume(com.roamprocess1.roaming4world.api.SipCallSession callInfo, int direction, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public com.roamprocess1.roaming4world.api.MediaState getCurrentMediaState() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.roamprocess1.roaming4world.api.MediaState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurrentMediaState, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.roamprocess1.roaming4world.api.MediaState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public void sendTyping(java.lang.String msg, java.lang.String toNumber, long accountId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_sendTyping = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_setPresence = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_getPresence = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_getPresenceStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_zrtpSASVerified = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_updateCallOptions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_zrtpSASRevoke = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_getLocalNatType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
}
/**
	* Get the current API version
	* @return version number. 1000 x major version + minor version
...
/**
	...
	* @return the Profile state
	*/
public com.roamprocess1.roaming4world.api.SipProfileState getSipProfileState(int accountId) throws android.os.RemoteException;
//Call configuration control
/**
	 * Switch next incoming request to auto answer
	 */
...
public com.roamprocess1.roaming4world.api.SipCallSession getCallInfo(int callId) throws android.os.RemoteException;
public com.roamprocess1.roaming4world.api.SipCallSession[] getCalls() throws android.os.RemoteException;
...
public void adjustVolume(com.roamprocess1.roaming4world.api.SipCallSession callInfo, int direction, int flags) throws android.os.RemoteException;
public com.roamprocess1.roaming4world.api.MediaState getCurrentMediaState() throws android.os.RemoteException;
...
public void sendTyping(java.lang.String msg, java.lang.String toNumber, long accountId) throws android.os.RemoteException;
// Presence
