...
package com.roamprocess1.roaming4world.pjsip.earlylock;
...
import com.roamprocess1.roaming4world.pjsip.PjSipService.PjsipModule;
...
public class EarlyLockModule implements PjsipModule {
    ...
    private class WorkLocker extends Thread {
        ...
        WorkLocker(long time) {
            lockTime = time;
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.roamprocess1.roaming4world.earlylock");
            wl.acquire();
        }
