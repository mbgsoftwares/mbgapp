...
package com.roamprocess1.roaming4world.utils.accessibility;
	...
	public static AccessibilityWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(4)) {
			    instance = new com.roamprocess1.roaming4world.utils.accessibility.Accessibility4();
			}else {
			    instance = new com.roamprocess1.roaming4world.utils.accessibility.Accessibility3();
			}
		}
