 ...
 * 
 */
package com.roamprocess1.roaming4world.utils.clipboard;
    ...
    public static ClipboardWrapper getInstance(Context context) {
        if(instance == null) {
            if(Compatibility.isCompatible(11)) {
                instance = new com.roamprocess1.roaming4world.utils.clipboard.Clipboard11();
            }else {
                instance = new com.roamprocess1.roaming4world.utils.clipboard.Clipboard1();
            }
            if(instance != null) {
