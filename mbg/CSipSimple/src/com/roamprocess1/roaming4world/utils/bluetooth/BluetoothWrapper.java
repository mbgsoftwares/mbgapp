...
package com.roamprocess1.roaming4world.utils.bluetooth;
	...
	public static BluetoothWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(14)) {
		        instance = new com.roamprocess1.roaming4world.utils.bluetooth.BluetoothUtils14();
		    }else if(Compatibility.isCompatible(8)) {
                instance = new com.roamprocess1.roaming4world.utils.bluetooth.BluetoothUtils8();
			}else {
                instance = new com.roamprocess1.roaming4world.utils.bluetooth.BluetoothUtils3();
			}
		    if(instance != null) {
