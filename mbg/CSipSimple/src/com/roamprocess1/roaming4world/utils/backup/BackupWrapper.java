...
package com.roamprocess1.roaming4world.utils.backup;
	...
	public static BackupWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(8)) {
                instance = new com.roamprocess1.roaming4world.utils.backup.BackupUtils8();
			}else {
                instance = new com.roamprocess1.roaming4world.utils.backup.BackupUtils3();
			}
		    if(instance != null) {
