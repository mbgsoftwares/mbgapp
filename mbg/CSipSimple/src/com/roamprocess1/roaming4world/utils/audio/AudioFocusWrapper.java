...
package com.roamprocess1.roaming4world.utils.audio;
	...
	public static AudioFocusWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(8)) {
			    instance = new com.roamprocess1.roaming4world.utils.audio.AudioFocus8();
			}else {
			    instance = new com.roamprocess1.roaming4world.utils.audio.AudioFocus3();
			}
		}
