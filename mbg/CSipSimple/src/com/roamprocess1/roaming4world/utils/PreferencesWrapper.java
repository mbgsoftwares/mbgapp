...
public class PreferencesWrapper {
		...
		private static final long serialVersionUID = 1L;
	{
		...
		put(SipConfigManager.TCP_TRANSPORT_PORT, "7722");
        ...
        put(SipConfigManager.TSX_T1_TIMEOUT, "10");
	...
	private final static HashMap<String, Boolean> BOOLEAN_PREFS = new HashMap<String, Boolean>(){
		...
		put(SipConfigManager.ENABLE_DNS_SRV, false);    //made false for : Fail to init pjsua unknown error 320044 -- true
	...
	public String[] getCodecList() {
		...
		System.out.println("PreferencesWrapper Codecs_list"+TextUtils.split(prefs.getString(CODECS_LIST, ""),  Pattern.quote(CODECS_SEPARATOR) ));
