...
package com.roamprocess1.roaming4world.utils.video;
    ...
    public static VideoUtilsWrapper getInstance() {
        if (instance == null) {
            if (Compatibility.isCompatible(5)) {
                instance = new com.roamprocess1.roaming4world.utils.video.VideoUtils5();
            } else {
                instance = new com.roamprocess1.roaming4world.utils.video.VideoUtils3();
            }
        }
