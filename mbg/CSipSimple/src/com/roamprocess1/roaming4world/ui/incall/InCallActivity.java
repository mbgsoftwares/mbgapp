...
import com.roamprocess1.roaming4world.ui.PickupSipUri;
import com.roamprocess1.roaming4world.ui.incall.CallProximityManager.ProximityDirector;
import com.roamprocess1.roaming4world.ui.incall.DtmfDialogFragment.OnDtmfListener;
import com.roamprocess1.roaming4world.ui.incall.locker.IOnLeftRightChoice;
import com.roamprocess1.roaming4world.ui.incall.locker.InCallAnswerControls;
import com.roamprocess1.roaming4world.ui.incall.locker.ScreenLocker;
import com.roamprocess1.roaming4world.utils.CallsUtils;
...
import com.roamprocess1.roaming4world.utils.keyguard.KeyguardWrapper;
...
public class InCallActivity extends SherlockFragmentActivity implements IOnCallActionTrigger, 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK
                ...
                "com.roamprocess1.roaming4world.onIncomingCall");
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.roamprocess1.roaming4world.videoCall");
