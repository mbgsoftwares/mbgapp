...
package com.roamprocess1.roaming4world.ui.outgoingcall;
...
import com.roamprocess1.roaming4world.ui.account.AccountsLoader;
...
public class OutgoingCallListFragment extends CSSListFragment {
    ...
    public synchronized void onListItemClick(ListView l, View v, int position, long id) {
        if(mAdapter != null) {
        	System.out.println("Position in outgoing call chooser list : "+position);
