...
import com.roamprocess1.roaming4world.utils.contacts.ContactsSearchAdapter;
...
public class DialpadTestFragment extends SherlockFragment implements OnClickListener, OnLongClickListener,
    ...
    String stored_account_register_status;
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	...
    	TextView status_account=(TextView) v.findViewById(R.id.status);
    	LinearLayout onlinelayout= (LinearLayout) v.findViewById(R.id.onlineStatus);	
		if(status_account!=null)
		{
			
			System.out.println("Dialer Fragment");
			
			Typeface tf = Typeface.createFromAsset(getActivity().getAssets(), "fonts/NexaBold.otf");
				...
				if (prefs.getString(stored_account_register_status, "Connecting").equals("Online")) {
					...
					onlinelayout.setBackgroundColor(Color.parseColor("#F79141E"));
					onlinelayout.invalidate();
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        int action = getResources().getBoolean(R.bool.menu_in_bar) ? MenuItem.SHOW_AS_ACTION_NEVER : MenuItem.SHOW_AS_ACTION_NEVER;
    ...
    public void placeVMCall() {
        ...
        if (accountToUse >= 0) {
            ...
            if (!TextUtils.isEmpty(vmAcc.vm_nbr)) {
                ...
                (new ComponentName(getActivity(), com.roamprocess1.roaming4world.plugins.telephony.CallHandler.class).flattenToString()))) {
            // Case gsm voice mail
