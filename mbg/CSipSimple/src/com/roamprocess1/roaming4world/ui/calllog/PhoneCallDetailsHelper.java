...
public class PhoneCallDetailsHelper {
    ...
    public void setPhoneCallDetails(PhoneCallDetailsViews views, PhoneCallDetails details) {
    	...
    	System.out.println("PhoneCallDetailsHelper");
        ...
        if (!TextUtils.isEmpty(details.name)) {
        	...
        	System.out.println("PhoneCallDetailsHelper displayName == "+displayName);  
            ...
            if (!TextUtils.isEmpty(details.number)) {
            	...
            	/*
            	String string =details.number.toString();
    			String[] parts = string.split("<");
    			String mbNumber = parts[0];
    			System.out.println("PhoneCallDetailsHelper mbNumber== "+details.number.toString());
            	System.out.println("PhoneCallDetailsHelper mbNumber== "+mbNumber.replace('"', ' '));  
            	*/

                displayName = SipUri.getDisplayedSimpleContact(details.number);
        ...
        String num = displayName.toString();
        if(num.startsWith("011")){
        	num = num.substring(3);
        }
        views.nameView.setText(num);
       
        /*   if (!TextUtils.isEmpty(details.number)) { {*/
       if (!TextUtils.isEmpty(details.formattedNumber)){
        	
        	System.out.println("formattedNumber==="+details.formattedNumber);
        	
        	
        	
        	String string =details.formattedNumber.toString();
			String[] parts = string.split("@");
			String mbNumber = parts[0];
			System.out.println("mbNumber== "+mbNumber); 
	        
			String numb = mbNumber.toString();
	        if(numb.startsWith("011")){
	        	numb = numb.substring(3);
	        }

        	views.numberView.setText(numb);
            ...
            views.numberView.setText(numb);
            System.out.println("PhoneCallDetailsHelper== "+details.number.toString());  
            
        } else {
            // In this case we can assume that display name was set to unknown
        	String numq = displayName.toString();
            if(numq.startsWith("011")){
            	numq = numq.substring(3);
            }
        	views.numberView.setText(numq);
        }
    }
