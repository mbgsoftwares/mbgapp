...
/* package */class CallLogListItemHelper {
    ...
    @SuppressLint("SdCardPath") private void configureCallSecondaryAction(CallLogListItemViews views,
        ...
        if(d == null) {
            views.secondaryActionView.setImageResource(R.drawable.ic_menu_answer_call_recents);
        }else {
    ...
    private CharSequence getCallActionDescription(PhoneCallDetails details) {
    	...
    	System.out.println("CallLogListItemHelper");
