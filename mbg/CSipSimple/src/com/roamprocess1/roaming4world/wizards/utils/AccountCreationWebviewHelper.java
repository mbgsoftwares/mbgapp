...
package com.roamprocess1.roaming4world.wizards.utils;
    ...
    public static AccountCreationWebviewHelper getInstance() {
        if(instance == null) {
            if(Compatibility.isCompatible(8)) {
                instance = new com.roamprocess1.roaming4world.wizards.utils.AccountCreationWebviewHelper8();
            }else {
                instance = new com.roamprocess1.roaming4world.wizards.utils.AccountCreationWebviewHelper3();
            }
        }
