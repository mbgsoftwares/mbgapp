...
import com.roamprocess1.roaming4world.ui.filters.AccountFilters;
import com.roamprocess1.roaming4world.ui.prefs.GenericPrefs;
...
public class BasePrefsWizard extends GenericPrefs {
	...
	public void saveAccount_login(String wizardId,String account_name,String user_name,String server,String password_response) {
		boolean needRestart = false;

		PreferencesWrapper prefs = new PreferencesWrapper(getApplicationContext());
		account = wizard.buildAccount_login(account,account_name,user_name,server,password_response);
		account.wizard = wizardId;
		if (account.id == SipProfile.INVALID_ID) {
			// This account does not exists yet
		    prefs.startEditing();
