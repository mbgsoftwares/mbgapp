...
package com.roamprocess1.roaming4world.wizards.impl;
...
public class Basic extends BaseImplementation {
	...
	public SipProfile buildAccount_login(SipProfile account,String account_name,String user_name,String server,String password_response) {
		Log.d(THIS_FILE, "####begin of save ....");
		...
		account.acc_id = "<sip:" + SipUri.encodeUser(user_name.trim()) + "@"+serverParts[0].trim()+">";
		...
		account.realm = "*";
		account.username = user_name.trim();
		account.data = password_response;
		account.scheme = SipProfile.CRED_SCHEME_DIGEST;
		account.datatype = SipProfile.CRED_DATA_PLAIN_PASSWD;
		//By default auto transport
		account.transport = SipProfile.TRANSPORT_TCP;
		System.out.println("Basic:buildAccount_login buildAccount_login ");
