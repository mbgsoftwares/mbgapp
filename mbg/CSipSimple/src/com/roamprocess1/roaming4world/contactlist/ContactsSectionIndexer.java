...
public class ContactsSectionIndexer implements SectionIndexer {
	...
	public ContactsSectionIndexer(List<ContactItemInterface> contacts) {
		...
		System.out.println("ContactsSectionIndexer: contacts:size:"+mCount);
		mSections=getIndex();
...
//		}
	...
	public static String[] getIndex(){
		System.out.println("ContactsSectionIndexer:getIndex:isRomaing4worldContact"+RContactlist.isRomaing4worldContact);
		
		String[] stringIndex; 
		if(RContactlist.isRomaing4worldContact){
			//System.out.println("isRomaing4worldContact:true");
			stringIndex = ExampleDataSource.indexSearch.toArray(new String[ExampleDataSource.indexSearch.size()]);
		}else{
			System.out.println("isRomaing4worldContact:false");
			stringIndex = AllExampleDataSource.indexSearch.toArray(new String[AllExampleDataSource.indexSearch.size()]);
		}
