...
public final class SipManager {
     ...
     */
    public static final String INTENT_SIP_CONFIGURATION = "com.roamprocess1.roaming4world.service.SipConfiguration";
    /**
     ...
     */
    public static final String INTENT_SIP_SERVICE = "com.roamprocess1.roaming4world.service.SipService";
     ...
     * </p>
     */
    public static final String INTENT_SIP_ACCOUNT_ACTIVATE = "com.roamprocess1.roaming4world.accounts.activate";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_UI = "com.roamprocess1.roaming4world.phone.action.INCALL";
    /**
     * Action launched when the status icon clicked.<br/>
     * Should raise the dialer.
     */
    public static final String ACTION_SIP_DIALER = "com.roamprocess1.roaming4world.phone.action.DIALER";
    public static final String ACTION_SIP_R4W_HOME = "com.roamprocess1.roaming4world.R4W_HOME";
    
    /**
     * Action launched when a missed call notification entry is clicked.<br/>
     * Should raise call logs list.
     */
    public static final String ACTION_SIP_CALLLOG = "com.roamprocess1.roaming4world.phone.action.CALLLOG";
    /**
     * Action launched when a sip message notification entry is clicked.<br/>
     * Should raise the sip message list.
     */
    public static final String ACTION_SIP_MESSAGES = "com.roamprocess1.roaming4world.phone.action.MESSAGES";
    /**
     * Action launched when user want to go in sip favorites.
     * Should raise the sip favorites view.
     */
    public static final String ACTION_SIP_FAVORITES = "com.roamprocess1.roaming4world.phone.action.FAVORITES";
    /**
     * Action launched to enter fast settings.<br/>
     */
    public static final String ACTION_UI_PREFS_FAST = "com.roamprocess1.roaming4world.ui.action.PREFS_FAST";
    /**
     * Action launched to enter global csipsimple settings.<br/>
     */
    public static final String ACTION_UI_PREFS_GLOBAL = "com.roamprocess1.roaming4world.ui.action.PREFS_GLOBAL";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_CHANGED = "com.roamprocess1.roaming4world.service.CALL_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_CHANGED = "com.roamprocess1.roaming4world.service.ACCOUNT_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_REGISTRATION_CHANGED = "com.roamprocess1.roaming4world.service.REGISTRATION_CHANGED";
    /**
     * Broadcast sent when the state of device media has been changed.
     */
    public static final String ACTION_SIP_MEDIA_CHANGED = "com.roamprocess1.roaming4world.service.MEDIA_CHANGED";
    /**
     * Broadcast sent when a ZRTP SAS
     */
    public static final String ACTION_ZRTP_SHOW_SAS = "com.roamprocess1.roaming4world.service.SHOW_SAS";
    /**
     ...
     */
    public static final String ACTION_SIP_MESSAGE_RECEIVED = "com.roamprocess1.roaming4world.service.MESSAGE_RECEIVED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_RECORDED = "com.roamprocess1.roaming4world.service.CALL_RECORDED";

    // REGISTERED BROADCASTS
    /**
     * Broadcast to send when the sip service can be stopped.
     */
    public static final String ACTION_SIP_CAN_BE_STOPPED = "com.roamprocess1.roaming4world.service.ACTION_SIP_CAN_BE_STOPPED";
    /**
     * Broadcast to send when the sip service should be restarted.
     */
    public static final String ACTION_SIP_REQUEST_RESTART = "com.roamprocess1.roaming4world.service.ACTION_SIP_REQUEST_RESTART";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_OUTGOING_UNREGISTER = "com.roamprocess1.roaming4world.service.ACTION_OUTGOING_UNREGISTER";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_DEFER_OUTGOING_UNREGISTER = "com.roamprocess1.roaming4world.service.ACTION_DEFER_OUTGOING_UNREGISTER";

    // PLUGINS BROADCASTS
    /**
     * Plugin action for themes.
     */
    public static final String ACTION_GET_DRAWABLES = "com.roamprocess1.roaming4world.themes.GET_DRAWABLES";
    /**
     ...
     * </ul>
     */
    public static final String ACTION_GET_PHONE_HANDLERS = "com.roamprocess1.roaming4world.phone.action.HANDLE_CALL";
     ...
     */
    public static final String ACTION_INCALL_PLUGIN = "com.roamprocess1.roaming4world.sipcall.action.HANDLE_CALL_PLUGIN";
    
    public static final String EXTRA_SIP_CALL_MIN_STATE = "com.roamprocess1.roaming4world.sipcall.MIN_STATE";
    public static final String EXTRA_SIP_CALL_MAX_STATE = "com.roamprocess1.roaming4world.sipcall.MAX_STATE";
    public static final String EXTRA_SIP_CALL_CALL_WAY = "com.roamprocess1.roaming4world.sipcall.CALL_WAY";
     ...
     * </ul>
     */
    public final static String ACTION_REWRITE_NUMBER = "com.roamprocess1.roaming4world.phone.action.REWRITE_NUMBER"; 
    /**
     * Plugin action for audio codec.
     */
    public static final String ACTION_GET_EXTRA_CODECS = "com.roamprocess1.roaming4world.codecs.action.REGISTER_CODEC";
    /**
     * Plugin action for video codec.
     */
    public static final String ACTION_GET_EXTRA_VIDEO_CODECS = "com.roamprocess1.roaming4world.codecs.action.REGISTER_VIDEO_CODEC";
    /**
     * Plugin action for video.
     */
    public static final String ACTION_GET_VIDEO_PLUGIN = "com.roamprocess1.roaming4world.plugins.action.REGISTER_VIDEO";
    /**
     ...
     */
    public static final String AUTHORITY = "com.roamprocess1.roaming4world.db";
    /**
    ...
    /**
     * Uri for contact sync content provider.
     */
    public static final Uri CONTACT_SYNC_URI = Uri.parse(ContentResolver.SCHEME_CONTENT + "://"
            + AUTHORITY + "/"
            + DBContacts.CONTACT_SYNC_TABLE);
