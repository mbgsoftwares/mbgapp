...
public class SipMessage {
    ...
    /**
     * Added by : Amit Sharma - Roaming4world 
     * Flag for file download status 
     */
    public static final String FIELD_DATA_DOWNLOADED = "data_downloaded";
    /**
    ...
    public static final int MESSAGE_TYPE_DOWNLOAD_START = 7;
    
    public static final int MESSAGE_TYPE_DOWNLOAD_FINISH = 8;
    ...
    public SipMessage(String aForm, String aTo, String aContact, String aBody, String aMimeType,
            long aDate, int aType, String aFullFrom, int aData_downloaded) {
        from = aForm;
        to = aTo;
        contact = aContact;
        body = aBody;
        ...
        type = aType;
        fullFrom = aFullFrom;
        data_downloaded = aData_downloaded;
    }
    ...
    public ContentValues getContentValues() {
        ...
        cv.put(FIELD_DATA_DOWNLOADED, data_downloaded);
        return cv;
    }
