...
import com.roamprocess1.roaming4world.api.SipUri.ParsedSipUriInfos;
...
public class SipProfile implements Parcelable {
     ...
     */
    public boolean allow_contact_rewrite = false;	/* by default it was true */
    /**
    ...
    public static ArrayList<SipProfile> getAllProfiles_login(Context ctxt, boolean onlyActive) {
        return getAllProfiles(ctxt, onlyActive, DBProvider.ACCOUNT_FULL_PROJECTION);
    }
