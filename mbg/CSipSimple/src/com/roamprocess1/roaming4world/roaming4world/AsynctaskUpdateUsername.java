...
public class AsynctaskUpdateUsername extends AsyncTask<Void, Void, Boolean> {
	
	Context context;
	String number, actiontype, name;
	int action;
	
	public AsynctaskUpdateUsername(Context cont, String num, String username, int i) {
        super();
        // do stuff
        context = cont;
        number = num;
...
//	userPic = getBitmapFromURL("https://www.roaming4world.com/images/logo.png");
	...
	public boolean webServiceUsernameUpdate() {
		...
		try {
			Log.d("webServiceUsernameUpdate()", "called");
