...
public class CustomAdapterReg  extends ArrayAdapter<String>{
	    ...
	    public View getCustomView(int position, View convertView, ViewGroup parent) {
	    	...
	    	View row = inflater.inflate(R.layout.spinner_row_country_reg, parent, false);
