...
import com.roamprocess1.roaming4world.utils.Ringer;
import com.roamprocess1.roaming4world.utils.accessibility.AccessibilityWrapper;
import com.roamprocess1.roaming4world.utils.audio.AudioFocusWrapper;
import com.roamprocess1.roaming4world.utils.bluetooth.BluetoothWrapper;
import com.roamprocess1.roaming4world.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		*/
		...
		if(wifiLock == null) {
			wifiLock = wman.createWifiLock( 
							...
							"com.roamprocess1.roaming4world.InCallLock");
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.roamprocess1.roaming4world.onIncomingCall.SCREEN");
