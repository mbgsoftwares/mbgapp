...
import com.roamprocess1.roaming4world.ui.outgoingcall.OutgoingCallChooser;
		...
		if (action.equals(Intent.ACTION_NEW_OUTGOING_CALL) ) {
			...
			if(prefsWrapper.isValidConnectionForOutgoing() || potentialHandlers.size() > 1) {
	            ...
	            if(gsmCallHandlerId == null) {
	                gsmCallHandlerId = CallHandlerPlugin.getAccountIdForCallHandler(aContext, (new ComponentName(aContext, com.roamprocess1.roaming4world.plugins.telephony.CallHandler.class)).flattenToString());
	            }
