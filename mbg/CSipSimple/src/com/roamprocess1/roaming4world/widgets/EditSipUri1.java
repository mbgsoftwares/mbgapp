...
public class EditSipUri1 extends LinearLayout implements TextWatcher, OnItemClickListener{
	 ...
	 protected static final String THIS_FILE = "EditSipUri";
	    ...
	    public String s;
	    public Cursor c;
	    public EditSipUri1(Context context, AttributeSet attrs) {
	        super(context, attrs);
	    ...
	    protected void onAttachedToWindow() {
	        ...
	        completeList.setOnItemClickListener(EditSipUri1.this);
	    ...
	    {        
	        ...
	        public Boolean doInBackground(Void... params) {
	            if(webservreqMAPNOGET1()){
	               ...
	               {
	            	   Looper.prepare();
			        contactsAdapter = new ContactAdapter(EditSipUri1.this.getContext(), c);
			        System.out.println("after contactadapter");
			        completeList.setAdapter(contactsAdapter);
			        completeList.setOnItemClickListener(EditSipUri1.this);
			        System.out.println("after clicklistener");
			        autoCompleteAdapter = new ContactsAutocompleteAdapter(EditSipUri1.this.getContext());
			        System.out.println("after contactautocompleteadapter");
			        dialUser.setAdapter(autoCompleteAdapter);
	               }
	               catch(Exception e)
