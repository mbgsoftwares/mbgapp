...
import com.roamprocess1.roaming4world.utils.AccountListUtils;
import com.roamprocess1.roaming4world.utils.AccountListUtils.AccountStatusDisplay;
...
public class AccountChooserButton extends LinearLayout implements OnClickListener {
    ...
    public AccountChooserButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        telCmp = new ComponentName(getContext(), com.roamprocess1.roaming4world.plugins.telephony.CallHandler.class);
    ...
    public void setAccount(SipProfile aAccount) {
        ...
        if (account == null) {
        	...
        	SetSenderUriInfo.onlineStatus = false;
        	...
        	SetSenderUriInfo.onlineStatus = true;
    ...
    public SipProfile getSelectedAccount() {
    	...
    	System.out.println("getSelectedAccount");
        if (account == null) {
