...
package com.roamprocess1.roaming4world.widgets.contactbadge;
...
public class QuickContactBadge extends FrameLayout {
    ...
    public QuickContactBadge(Context context, AttributeSet attrs, int defStyle) {
        ...
        String className = "com.roamprocess1.roaming4world.widgets.contactbadge.ContactBadge";
    ...
    public void overlay(Canvas c, ImageView img) {
        if (arrowPos != ArrowPosition.NONE) {
            ...
            int x_inside = x_border + ((arrowPos == ArrowPosition.LEFT) ? 1 : -1 ) * (int)(img.getWidth() * 0.1f);
            int y_top = (int) (img.getHeight() * 0.1f);
            int y_top_edit = (int) (img.getHeight() * 0.4f);
            int y_bottom = (int) (img.getHeight() * 0.2f);
            ...
            path.moveTo(x_border, y_top_edit);
            path.lineTo(x_inside, (y_top_edit + y_bottom)/2);
            path.lineTo(x_border, y_bottom);
            path.lineTo(x_border, y_top_edit);
            path.close();
