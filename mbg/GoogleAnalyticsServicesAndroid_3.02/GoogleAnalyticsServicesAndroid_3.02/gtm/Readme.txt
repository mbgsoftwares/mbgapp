...
to do server-side rule-based customization of configuration variables and/or
rule-based firing of tags, including Google Analytics tags, and to do
experimentation (A/B testing) on configuration variables.
